...
public class OgrenciRepository {
    ...
    {
        // prepstat
        String sql = "INSERT INTO \"OBS\".\"OGRENCI\"(\"OGR_NUM\", \"NAME\") VALUES (:OGR_NUMBER, :OGR_NAME)";
    ...
    {
        // prepstat
        String sql = "DELETE FROM \"OBS\".\"OGRENCI\" WHERE \"OGR_NUM\" = :OGRENCI_NUM";
        HashMap<String, Object> paramMap = new HashMap<>();
        paramMap.put("OGRENCI_NUM", number);
        return namedParameterJdbcTemplate.update(sql, paramMap) != 0;
    }
